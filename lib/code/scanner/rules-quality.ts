...
export const BAD_PRACTICE_RULES: ScanRule[] = [
  ...
  },
  {
    ...
    patternOptions: { regex: true },
    fileFilter: TS_ONLY,
    excludePattern: /eslint-disable|@ts-ignore|@ts-expect-error|\/\/.*any|require\(|module\.exports|as any \/\/|as unknown as|catch\s*\(/i,
    confidence: 'medium',
    fix: ': unknown',
  ...
  },
  {
    ...
    patternOptions: { regex: true },
    excludePattern: /eslint-disable.*--|eslint-disable.*reason|eslint-disable.*because/i,
    confidence: 'low',
  },
  {
    id: 'empty-catch',
  ...
  },
  {
    ...
    patternOptions: { regex: true },
    fileFilter: JS_TS,
    excludePattern: /const|enum|type|interface|\/\/|\*|\.test\.|config|\b(?:200|201|204|301|302|400|401|403|404|409|500|502|503)\b|\b(?:80|443|3000|5432|6379|8080|8443|9090)\b/i,
    confidence: 'low',
  },
  {
    id: 'python-os-system',
