...
`,
  ...
  expected: [
    { ruleId: 'hardcoded-password', line: 5, expectation: 'present' },
    { ruleId: 'hardcoded-secret', line: 6, expectation: 'present' },
    { ruleId: 'jwt-algo-none', line: 9, expectation: 'present' },
    { ruleId: 'hardcoded-secret', line: 13, expectation: 'present' },
    { ruleId: 'weak-hash', line: 16, expectation: 'present' },
    { ruleId: 'jwt-weak-secret', line: 21, expectation: 'present' },
    { ruleId: 'jwt-no-verify', line: 34, expectation: 'present' },
    { ruleId: 'weak-hash', line: 46, expectation: 'present' },
    { ruleId: 'insecure-random', line: 50, expectation: 'present' },
    { ruleId: 'weak-hash', line: 56, expectation: 'present' },
  ],
...
`,
  ...
  expected: [
    { ruleId: 'python-yaml-load', line: 18, expectation: 'present' },
    { ruleId: 'python-pickle', line: 28, expectation: 'present' },
    { ruleId: 'python-subprocess-shell', line: 39, expectation: 'present' },
    { ruleId: 'python-exec', line: 53, expectation: 'present' },
    { ruleId: 'python-exec', line: 58, expectation: 'present' },
  ],
...
`,
  ...
  expected: [
    { ruleId: 'hardcoded-secret', line: 3, expectation: 'present' },
    { ruleId: 'hardcoded-secret', line: 4, expectation: 'present' },
    { ruleId: 'weak-hash', line: 7, expectation: 'present' },
    { ruleId: 'weak-hash', line: 12, expectation: 'present' },
    { ruleId: 'weak-hash', line: 17, expectation: 'present' },
    { ruleId: 'weak-hash', line: 44, expectation: 'present' },
  ],
...
`,
  ...
  expected: [
    { ruleId: 'command-injection-require-cp', line: 5, expectation: 'present' },
    { ruleId: 'composite-file-upload-no-validation', line: 2, expectation: 'present' },
    { ruleId: 'command-injection-template', line: 26, expectation: 'present' },
    { ruleId: 'command-injection-template', line: 31, expectation: 'present' },
    { ruleId: 'path-traversal', line: 51, expectation: 'present' },
  ],
  groundTruth: { expectedVulnCount: 5, expectedClean: false },
}
...
`,
  ...
  expected: [
    { ruleId: 'eval-usage', line: 29, expectation: 'present' },
    { ruleId: 'command-injection-exec-direct', line: 46, expectation: 'present' },
  ],
