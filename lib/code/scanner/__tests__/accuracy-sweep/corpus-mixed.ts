...
`,
  ...
  expected: [
    { ruleId: 'console-log', line: 12, expectation: 'present' },
    { ruleId: 'console-log', line: 17, expectation: 'present' },
    { ruleId: 'console-log', line: 27, expectation: 'present' },
    { ruleId: 'todo-fixme', line: 3, expectation: 'present' },
    { ruleId: 'todo-fixme', line: 4, expectation: 'present' },
    { ruleId: 'todo-fixme', line: 20, expectation: 'present' },
    { ruleId: 'todo-fixme', line: 28, expectation: 'present' },
    { ruleId: 'var-usage', line: 6, expectation: 'present' },
    { ruleId: 'var-usage', line: 9, expectation: 'present' },
    { ruleId: 'var-usage', line: 15, expectation: 'present' },
  ],
...
`,
  ...
  expected: [
    { ruleId: 'eval-usage', line: 69, expectation: 'present' },
  ],
