...
`,
  ...
  expected: [
    { ruleId: 'express-cors-credentials-wildcard', line: 16, expectation: 'present' },
    { ruleId: 'express-body-parser-no-limit', line: 17, expectation: 'present' },
    { ruleId: 'hardcoded-secret', line: 19, expectation: 'present' },
    { ruleId: 'sql-injection', line: 35, expectation: 'present' },
    { ruleId: 'error-stack-exposure', line: 45, expectation: 'present' },
    { ruleId: 'sql-injection', line: 55, expectation: 'present' },
    { ruleId: 'error-stack-exposure', line: 66, expectation: 'present' },
    { ruleId: 'sql-injection', line: 72, expectation: 'present' },
    { ruleId: 'error-stack-exposure', line: 75, expectation: 'present' },
    { ruleId: 'express-no-helmet', line: 6, expectation: 'present' },
    { ruleId: 'express-no-rate-limit', line: 31, expectation: 'present' },
    { ruleId: 'composite-csrf-missing-express', line: 31, expectation: 'present' },
  ],
...
`,
  ...
  expected: [
    { ruleId: 'nextjs-api-no-auth', line: 3, expectation: 'present' },
    { ruleId: 'composite-ssrf', line: 12, expectation: 'present' },
    { ruleId: 'cors-wildcard', line: 43, expectation: 'present' },
    { ruleId: 'error-stack-exposure', line: 47, expectation: 'present' },
    { ruleId: 'nextjs-api-no-auth', line: 28, expectation: 'present' },
  ],
...
`,
  ...
  expected: [
    { ruleId: 'python-django-debug', line: 9, expectation: 'present' },
    { ruleId: 'django-csrf-exempt', line: 11, expectation: 'present' },
    { ruleId: 'django-raw-sql', line: 15, expectation: 'present' },
    { ruleId: 'django-csrf-exempt', line: 22, expectation: 'present' },
    { ruleId: 'django-raw-sql', line: 30, expectation: 'present' },
    { ruleId: 'django-raw-sql', line: 36, expectation: 'present' },
    { ruleId: 'django-mark-safe', line: 44, expectation: 'present' },
    { ruleId: 'django-csrf-exempt', line: 48, expectation: 'present' },
    { ruleId: 'django-raw-sql', line: 54, expectation: 'present' },
  ],
...
`,
  ...
  expected: [
    { ruleId: 'flask-secret-key-hardcoded', line: 6, expectation: 'present' },
    { ruleId: 'python-os-system', line: 17, expectation: 'present' },
    { ruleId: 'python-subprocess-shell', line: 27, expectation: 'present' },
    { ruleId: 'python-exec', line: 38, expectation: 'present' },
    { ruleId: 'flask-debug-mode', line: 48, expectation: 'present' },
  ],
  groundTruth: { expectedVulnCount: 5, expectedClean: false },
}
...
`,
  ...
  expected: [
    { ruleId: 'spring-csrf-disabled', line: 24, expectation: 'present' },
    { ruleId: 'sql-injection', line: 38, expectation: 'present' },
  ],
